...
import { CheckPermission, GetAndParsePropertyData, GetChunkPropertyId, GetPlayerChunkPropertyId, StringifyAndSavePropertyData } from "../../lib/util.js";
import { nameSet } from "../../lib/nameset.js";
import { country } from "../api.js";
import { ItemStack, Player, system, world } from "@minecraft/server";
import config from "../../config.js";
import { acceptFriendlyRequestFunction, denyFriendlyRequestFunction, removeFriendlyFunction, sendFriendlyRequestFunction } from "./lib/friendly.js";
import { acceptApplicationRequestFunction, denyApplicationRequestFunction, sendApplicationRequestFunction } from "./lib/application.js";
import { acceptAllianceRequestFunction, denyAllianceRequestFunction, removeAllianceFunction, sendAllianceRequestFunction } from "./lib/alliance.js";
import { addHostilityFunction } from "./lib/hostility.js";
import { denyMergeRequestFunction, sendMergeRequestFunction } from "./lib/merge.js";
import { inviteFunction } from "./lib/invite.js";
import { setNewOwnerFunction } from "./lib/owner.js";
import { RoleManager } from "./role.js";
import { DeleteCountry, MergeCountry } from "../../lib/land.js";
import national_tier_level from "../../national_tier_level.js";
import { updateRecipe } from "../../lib/recipe.js";
...
export class CountryManager {
    ...
    getCountryInfoRawText() {
        ...
        const membersId = this.countryData.members.filter((m: any) => m != ownerData.id);
