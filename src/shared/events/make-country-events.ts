...
export const playerHandler = {
    afterEvents: {
        /** @type {EventManager<{player: Player, message: string, type: 'general'|'country'|'alliance'|'federation'|'local'}>} */
        chat: new EventManager(),
        /** @type {EventManager<{player: Player, args: Array<string>, commandName: string}>} */
        command: new EventManager(),
    },
    beforeEvents: {
        /** @type {EventManager<{player: Player, message: string, type: 'general'|'country'|'alliance'|'federation'|'local',cancel: boolean}>} */
        chat: new EventManager(),
