...
import { setFriendlyPermissionDefaultForm } from "./set_friendly_permission.js";
import { FriendlyListDefaultForm } from "./list/friendly_list.js";
/** */
 ...
 * @param {Player} player 
 */
export function FriendlyMainDefaultForm(player: any) {
