...
import { countryInvitesListDefaultForm } from "./invite/invite_list.js";
import { allowJoinCountriesListDefaultForm } from "./allow_list/allow_list.js";

/**
 * 国に参加するときの形式選択
 * @param {Player} player 
 */
export function joinTypeSelectDefaultForm(player: any) {
