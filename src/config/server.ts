export default {
    ...
    MoneyName: `$`,
    bountyValidity: true,
    bountyMinAmount: 10000,
    bountyTargetMinDays: 7,
    bountyDailyLimit: 10,
    bountyTargetRespawnCooldownHours: 1,
    bountySetCooldownHours: 24,
    //初期の国庫の金
    ...
    //荒野で許可する権限
    wildernessAllowPermissions: [`entityUse`, `blockUse`, `makeCountry`, `buyChunk`, 'itemUse', 'projectileUse', 'entityAttack', 'playerAttack', `place`, `break`, `setHome`, `openContainer`],
