...
import { GetAndParsePropertyData, StringifyAndSavePropertyData, isDecimalNumber, langChangeItemName } from "@/shared/utils/minecraft.js";
import { DynamicProperties } from "@/shared/storage/dynamic-properties.js";
import config from "@/config/server.js";
import { SmartPhoneHomeScreen } from "@/features/smartphone/smartphone.js";
 ...
 * @param {Player} player 
 */
export function KarcariApp(player: any) {
 ...
 * @param {Player} player 
 */
function PlayerMarketCommonsMenu(player: any, page = 0, keyword = ``, type = 0) {
