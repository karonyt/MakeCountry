...
import { allowJoinCountriesListDefaultForm } from "@/features/forms/default/menu/join/allow_list/allow_list.js";
 ...
 */
export function joinCheckFromListDefaultForm(player: any, countryData: any) {
    try {
