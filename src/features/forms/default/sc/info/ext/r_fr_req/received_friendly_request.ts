...
import { friendlyRequestCountryDefaultForm } from "@/features/forms/default/sc/info/ext/r_fr_req/friendly_request_country.js";
 ...
 * @param {Player} player 
 */
export function ReceivedFriendlyRequestDefaultForm(player: any) {
