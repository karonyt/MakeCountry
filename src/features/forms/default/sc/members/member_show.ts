...
import { playerKickCheckDefaultForm } from "@/features/forms/default/sc/members/player_kick/check.js";
import { playerRoleChangeDefaultForm } from "@/features/forms/default/sc/members/player_role_change/change.js";
import { playerOwnerChangeCheckDefaultForm } from "@/features/forms/default/sc/members/owner_change/check.js";
 ...
 */
export function memberSelectedShowDefaultForm(player: any, member: any, countryData: any) {
    /**
     * @type {RawMessage}
     */
    const bodyData = [
