...
import { CheckPermission, GetAndParsePropertyData, GetChunkPropertyId, GetPlayerChunkPropertyId, StringifyAndSavePropertyData } from "./util.js";
        ...
        try {
            ...
            for (const f of fields) {
                if (Array.isArray(c[f])) {
                    ...
                    c[f] = c[f].filter((id: any) => String(id) !== targetId);
